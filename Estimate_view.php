...
<div class="container py-3">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="fw-semibold mb-0" id="invoiceNumber">ESTIMATE #26</h4>

        <div>
            <button class="btn btn-primary btn-sm" id="emailInvoiceBtn">
                <i class="bi bi-envelope"></i> Email estimate to client
            </button>
        </div>
    </div>
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0 rounded-3">
                ...
                <li>
                    <button class="dropdown-item py-2" onclick="window.location='invoice_edit.php'">
                        <i class="bi bi-pencil-square me-2"></i> Edit ESTIMATE
                    </button>
                </li>
                ...
                <li>
                    <button class="dropdown-item py-2" onclick="cloneInvoice()">
                        <i class="bi bi-files me-2"></i> Clone ESTIMATE
                    </button>
                </li>
...
<div class="modal fade" id="emailInvoiceModal" tabindex="-1">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content rounded-4">
            ...
            <div id="emailStep1">
                <div class="modal-header border-0">
                    <h5 class="modal-title fw-semibold">Email Estimate</h5>
                    <button class="btn-close" data-bs-dismiss="modal"></button>
                </div>
