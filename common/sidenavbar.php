<div class="leftside-menu">
      <a href="index.html" class="logo text-center logo-light">
        <span class="logo-lg">
          <img src="assets/images/tech-logo21.webp" alt="" height="40" width="216" />
        </span>
        <span class="logo-sm">
          <img src="assets/images/users/unnamed.jpg" alt="" height="50" width="50" />
        </span>
      </a>
        ...
        <div class="sidebar">
          <ul class="side-nav">
           ...
           <li class="side-nav-item">
            ...
            <li class="side-nav-item">
              <a class="side-nav-link text-decoration-none d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
                ...
                <div class="d-flex align-items-center">
                  ...
                  <span>Sales <i class="fa-solid fa-angle-down me-2"></i></span>
                </div>
              </a>
            ...
            <li class="side-nav-item">
              <a class="side-nav-link text-decoration-none d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
                ...
                <div class="d-flex align-items-center">
                  ...
                  <span>Prospects <i class="fa-solid fa-angle-down me-2"></i></span>
                </div>
              </a>
              <div class="collapse" id="prospectMenu">
                <ul class="nav flex-column ms-4">
                  <li><a href="Estimate.php" class="nav-link text-secondary">Estimate </a></li>
            ...
            <li class="side-nav-item">
              <a class="side-nav-link text-decoration-none d-flex justify-content-between align-items-center" data-bs-toggle="collapse"
                ...
                <div class="d-flex align-items-center">
                  ...
                  <span>Team <i class="fa-solid fa-angle-down me-2"></i></span>
                </div>
              </a>
              <div class="collapse" id="TeamMenu">
                <ul class="nav flex-column ms-4">
                  <li><a href="#" class="nav-link text-secondary">Team Members</a></li>
                  <li><a href="#" class="nav-link text-secondary">Time Cards</a></li>
                  <li><a href="#" class="nav-link text-secondary">Leave</a></li>
            ...
            <!-- Your remaining menu items (unchanged) -->
