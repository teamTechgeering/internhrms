                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="mb-1" id="companyAddress1">86935 Greenholt Forges</p>
                            <p class="mb-1" id="companyAddress2">Bhubaneswar, 751012</p>
                            <p class="mb-1" id="companyPhone">Phone: +91 8480889880</p>
                            <p class="mb-1" id="companyEmail">Email: info@techgeering.com</p>
                            <p class="mb-1" id="companyWebsite">Website: https://www.techgeering.in/</p>
                        ...
                        <div class="col-md-6 text-md-end mt-3 mt-md-0">
                            ...
                            <p class="mb-1" id="clientAddr1">308 Thad Row</p>
                            <p class="mb-1" id="clientAddr2">Lake Macmouth</p>
                            <p class="mb-1" id="clientAddr3">Tennessee</p>
                            <p class="mb-1" id="clientCountry">Andorra</p>
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle" id="itemsTable">
                            ...
                            <tbody id="itemRows">
                                ...
                                <!-- Default Item Row (will be replaced by JS) -->
                                <tr>
                                    <td>
                    ...
                    <button class="btn btn-outline-primary btn-sm mb-3" data-bs-toggle="modal" data-bs-target="#addItemModal" id="openAddItemBtn">
...
<div class="card shadow-sm border-0 mb-3">
    ...
    <div class="card shadow-sm border-0 mb-3">
        ...
        <div class="list-group list-group-flush">
            ...
            <!-- Payments list container (JS will populate) -->
            <div class="p-2">
                <ul id="paymentList" class="list-unstyled small mb-0"></ul>
            </div>
        </div>
    </div>
    ...
    <div class="card shadow-sm border-0 mb-3">
        ...
        <div class="list-group list-group-flush">
            ...
            <div class="p-2">
                <ul id="taskList" class="list-unstyled small mb-0"></ul>
            </div>
        </div>
    </div>
...
<!-- SMALL SCRIPT TO PASS ID TO JS -->
<script>
    // invoiceId is read from URL by PHP and passed to JS
