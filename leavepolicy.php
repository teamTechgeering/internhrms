...
<div class="col-lg-3">
    ...
    <div class="list-group list-group-flush">
        ...
        <a class="list-group-item border-0 fw-medium">Leave policy</a>
    </div>
</div>
...
<div class="col-lg-9">
    ...
    <div class="text-muted mb-3">
        <i class="bi bi-house"></i> / <span id="breadcrumb">Leave policy</span>
    ...
    <p id="desc">Information about the leave of our team members.</p>

    <div class="mt-4">
        <div><i class="bi bi-file-earmark-text"></i> How much leave I can enjoy in a year?</div>
        <div class="mt-2"><i class="bi bi-file-earmark-text"></i> How much paid leave I can get in a year?</div>
    </div>
</div>
