...
<div class="container-fluid px-4 mt-3">
  ...
  <nav class="navbar navbar-light bg-white shadow-sm p-3 mb-3 rounded">
    <div class="container-fluid px-0">
      ...
      <a href="Clients.html" class="btn btn-outline-secondary btn-sm">
  ...
  <div class="d-flex align-items-center justify-content-between mb-3">
    <div>
      <h3 class="fw-bold mb-0" id="clientName">Loading...</h3>
      <div class="text-muted small" id="clientTagline">-</div>
    </div>
    <div class="text-end">
...
<div class="modal fade" id="projectSuccessModal">
  <div class="modal-dialog modal-dialog-centered">
    ...
    <div class="tab-pane fade" id="subscriptions">
      <div class="card shadow-sm border-0"><div class="card-body"><h5>Subscriptions</h5><p id="subscriptionInfo">No subscriptions found.</p></div></div>
    </div>

    <div class="tab-pane fade" id="invoicesTab">
      <div class="card shadow-sm border-0"><div class="card-body"><h5>Invoices</h5><p>Total Invoiced: $<span id="invoiceTotal">0</span></p></div></div>
    </div>

    <div class="tab-pane fade" id="paymentsTab">
      <div class="card shadow-sm border-0"><div class="card-body"><h5>Payments</h5><p>No payments found.</p></div></div>
    </div>

    <div class="tab-pane fade" id="orders">
      <div class="card shadow-sm border-0"><div class="card-body"><h5>Orders</h5><p>No orders found.</p></div></div>
    </div>

    <div class="tab-pane fade" id="estimates">
      <div class="card shadow-sm border-0"><div class="card-body"><h5>Estimates</h5><p>No estimates found.</p></div></div>
    </div>

    <div class="tab-pane fade" id="proposals">
      <div class="card shadow-sm border-0"><div class="card-body"><h5>Proposals</h5><p>No proposals found.</p></div></div>
    </div>

    <div class="tab-pane fade" id="contracts">
      <div class="card shadow-sm border-0"><div class="card-body"><h5>Contracts</h5><p>No contracts available.</p></div></div>
    </div>

    <div class="tab-pane fade" id="files">
      <div class="card shadow-sm border-0"><div class="card-body"><h5>Files</h5><p>No files uploaded.</p></div></div>
    </div>

    <div class="tab-pane fade" id="expenses">
      <div class="card shadow-sm border-0"><div class="card-body"><h5>Expenses</h5><p>No expenses found.</p></div></div>
    </div>
